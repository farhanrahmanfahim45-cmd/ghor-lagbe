...
import { taka, lastUpdatedLabel, lastUpdatedShort, isStale } from "@/lib/format";
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2.5 p-3.5">
        ...
        <div className="mt-auto flex items-center gap-3 border-t border-hairline pt-2.5 text-xs text-ink-soft">
          ...
          <span
            title={lastUpdatedLabel(property.lastUpdated)}
            className={cn("ml-auto shrink-0", stale ? "font-medium text-warn-700" : "text-muted")}
          >
            {lastUpdatedShort(property.lastUpdated)}
          </span>
        </div>
      </div>
    </article>
