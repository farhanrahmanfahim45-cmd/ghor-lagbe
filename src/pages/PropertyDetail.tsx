...
import { MatchBreakdown } from "@/components/property/MatchBreakdown";
...
export default function PropertyDetail() {
  ...
  const { isSaved, toggleSaved, isComparing, toggleCompare, requirements, hasStatedRequirements } = useAppState();
  ...
  return (
    <div className="container-page py-6 md:py-10">
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_22rem]">
        ...
        <aside className="lg:sticky lg:top-24 lg:self-start">
          {hasStatedRequirements && (
            <div className="mb-4">
              <MatchBreakdown match={scoreProperty(property, requirements)} />
            </div>
          )}
      ...
      <InquiryModal property={property} open={inquiryOpen} onClose={() => setInquiryOpen(false)} />
    </div>
  );
}
